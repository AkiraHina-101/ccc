...
' Fixed OVERALL series layout: one series for each existing Model.
' Moi Model OVERALL chi co mot series.
Public Const OVERALL_SERIES_PER_MODEL As Long = 1

' OVERALL is split into band and all-band views.
Public Const OVERALL_BAND_SHEET As String = "OVERALL-1_3 OctaveBand"
Public Const OVERALL_BROAD_SHEET As String = "OVERALL"
