...
# command history for "make component transparent":
#   *createmark components 1 "by id" <ids>
#   *setmarkdisplayattributes components 1 4 1   ;# 1 = transparent FE style
#   *setmarkdisplayattributes components 1 4 0   ;# 0 = normal FE style
...
proc ::nc::ui_table::_on_reset_transparency {} {
    ...
    set rc [catch {
        ...
        *setmarkdisplayattributes components 1 4 0
        catch {*endnotehistorystate {Modified FE style of Component}}
    } err]
    if {$rc} {
