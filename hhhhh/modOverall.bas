...
Private Sub RefreshOneOverallChart(ByVal ws As Worksheet, _
    ...
    Dim seriesIndex As Long, modelIndex As Long, valueColumn As Long
    ...
    For seriesIndex = 1 To allSeries.Count
        modelIndex = ((seriesIndex - 1) \ OVERALL_SERIES_PER_MODEL) + 1
        If modelIndex > MAX_MODEL_COUNT Then Exit For
...
Private Sub SetOverallModelVisible(ByVal modelIndex As Long, _
    ...
    Dim firstSeriesIndex As Long, seriesOffset As Long
    ...
    chartNames = Array("chOverallMulti_1", "chOverallMulti_2", _
                       ...
                       "chOverallSingle_3", "chOverallSingle_4")
    firstSeriesIndex = (modelIndex - 1) * OVERALL_SERIES_PER_MODEL + 1
