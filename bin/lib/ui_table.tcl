...
proc ::nc::ui_table::_selected_label_value {} {
    ...
    return [$_label_list get [lindex $sel 0]]
}
...
proc ::nc::ui_table::_label_refresh_list {} {
    ...
    foreach v [_label_values_filtered] { $_label_list insert end $v }
...
proc ::nc::ui_table::_open_label_palette {{preferred ""} {r ""} {c ""}} {
    ...
    if {$_label_win eq "" || ![winfo exists $_label_win]} {
        ...
        pack $_label_win.buttons.assign $_label_win.buttons.fill $_label_win.buttons.seq $_label_win.buttons.paste $_label_win.buttons.apply $_label_win.buttons.cancel -side left -padx 3 -pady 4
...
proc ::nc::ui_table::_format_mass_value {value} {
    ...
    if {$_mass_unit eq "ton"} {
        set numeric [expr {$numeric / 1000.0}]
    }
    return [_format_decimal_trim $numeric 6]
}
...
proc ::nc::ui_table::_on_isolate {} {
    set rows [get_selected_rows]
    _set_status "Isolate preview: [llength $rows] selected row(s); no graphics/model command called." ok
}
